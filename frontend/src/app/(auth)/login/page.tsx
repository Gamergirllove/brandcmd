        ...
        >
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="px-2 text-xs" style={{ background: "var(--surface)", color: "var(--text-dim)" }}>
                Or continue with
              </span>
            </div>
          </div>
...
export default function LoginPage() {
  // useSearchParams (for ?redirectedFrom=) needs a Suspense boundary,
  // otherwise the whole route bails out of static rendering.
  return (
